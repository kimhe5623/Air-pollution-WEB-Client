...
export class HEADER {
    ...
    // Google maps API key
    public static readonly GOOGLE_MAP_API_KEY = "AIzaSyDZuNOsq6BPWzDxVIbUMTQbuQqxnO55xmY";
    ...
    public static readonly RESCODE_SWP_SAS: any = {
        OK: 0, OTHER: 1, UNALLOCATED_USER_SEQUENCE_NUMBER: 2, INCORRECT_NUMBER_OF_SIGNED_IN_COMPLETIONS: 3, NOT_EXIST_WIFI_MAC_ADDRESS: 4, ALREADY_ASSOCIATED_WITH_USN: 5, ALREADY_ASSOCIATED_WITH_OTHER: 6
    }
