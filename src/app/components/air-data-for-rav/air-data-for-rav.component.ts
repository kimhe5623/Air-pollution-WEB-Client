...
@Component({
  selector: 'app-air-data-for-rav',
  templateUrl: './air-data-for-rav.component.html',
  styleUrls: ['./air-data-for-rav.component.css']
})
export class AirDataForRavComponent implements OnInit {
  @Input() radius: number;
  ...
  ngDoCheck() {
    ...
    if (changes) {
      ...
      this.temp = this.data['temperature'];
